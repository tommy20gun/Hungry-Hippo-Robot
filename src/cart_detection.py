...
def plot_axes_on_frame(frame):
    ...
    if ret_qr:
        ...
        #                 [0.0, 0.0, 1.0]])
        cmtx = np.array([[1522.1557891642256, 0.0, 872.0556558211771],
                         [0.0, 1517.1086599607072, 474.32183175939747],
                         [0.0, 0.0, 1.0]])
        ...
        dist = np.array([0.32864019585553905, -2.4079850380493886, -0.0027708281724901666, 0.014413545561077778, 5.532291365742394])
